...
public class ITSUrlResolverTest
{
  ...
  public void testResolveResourceUrls() {
      IITSDocument itsDocument =  ITSDocumentFixture.getITSDocumentWithLinks();
      ...
      final String content = resolver.resolveResourceUrls(itsDocument.getContentsValues().get(0).getStem());
