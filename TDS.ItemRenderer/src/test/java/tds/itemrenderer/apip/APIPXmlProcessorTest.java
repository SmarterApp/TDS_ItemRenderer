...
public class APIPXmlProcessorTest extends AbstractTest {
    private APIPRuleGroup _apipRuleGroup;
    private ITSContent _content;
    private ITSDocumentXml _itsDocument;
    private AccProperties _accProperties;

    public APIPXmlProcessorTest() {
        AccLookup accLookup = new AccLookup();
        _accProperties = new AccProperties(accLookup);
    }
    ...
    public void testTemp() throws Exception {
        ...
        APIPXmlProcessor processor = new APIPXmlProcessor(APIPMode.TTS, _apipRuleGroup, _accProperties);
    ...
    public void testProcessForBrailleWithA203() throws Exception {
        setup("/items/item-187-1689.xml", "TDS_TTX_A203");  //Regular
        Document document = XmlUtils.createFragmentDocument(_content.getStem());
        APIPXmlProcessor processor = new APIPXmlProcessor(APIPMode.Braille, _apipRuleGroup, _accProperties);
