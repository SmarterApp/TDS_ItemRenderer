...
@XmlRootElement(name = "accessibilityInfo")
public class AccessibilityInfo {

    @XmlElement(required = true)
    protected List<AccessElement> accessElement;
     ...
     * 
     */
    public List<AccessElement> getAccessElement() {
        if (accessElement == null) {
            accessElement = new ArrayList<AccessElement>();
        }
