 ...
 *
 */
public class APIPRuleTagTTS extends APIPRuleTag
{

  public APIPRuleTagTTS(String tag) {
     super(tag);
  }
  ...
  public String getValue(APIPAccessElement accessElement) {
      if (accessElement.getRelatedElementInfo().getReadAloud() != null) {
          return accessElement.getRelatedElementInfo().getReadAloud().getTtsPronunciation();
      }
      return null;
  }
