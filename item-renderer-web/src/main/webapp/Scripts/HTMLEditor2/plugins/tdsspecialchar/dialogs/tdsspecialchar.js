...
CKEDITOR.dialog.add( 'tdsspecialchar', function( editor ) {
	...
	return {
		...
		onLoad: function() {
            ...
            // insert instruction of special character
			var instruction = new CKEDITOR.dom.element('span');
		    instruction.addClass('cke_tdsspecialchar_instruction');
		    instruction.appendText(pluginInstructions);
			this.getContentElement('info', 'contentContainer').getElement().insertBeforeMe(instruction);
