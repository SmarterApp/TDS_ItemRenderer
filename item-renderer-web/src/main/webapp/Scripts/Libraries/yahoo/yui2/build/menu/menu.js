...
(function () {
    ...
    */
    YAHOO.widget.MenuManager = function () {
        ...
        */
        function onDOMEvent(sEventType, p_oEvent) {
            ...
            addMenu: function (p_oMenu) {
                ...
                if (p_oMenu instanceof YAHOO.widget.Menu && p_oMenu.id && 
                    ...
                    if (!m_bInitializedEventHandlers) {
                        ...
                        // TDS: We need listen on dom event but pass in original event name so existing logic works
                        Event.on(oDoc, 'pointerover', onDOMEvent.bind(this, _MOUSEOVER));
                        Event.on(oDoc, 'pointerout', onDOMEvent.bind(this, _MOUSEOUT));
                        Event.on(oDoc, 'pointerdown', onDOMEvent.bind(this, _MOUSEDOWN));
                        Event.on(oDoc, 'pointerup', onDOMEvent.bind(this, _MOUSEUP));
                        Event.on(oDoc, 'pointerdown', onDOMEvent.bind(this, _CLICK));
                        Event.on(oDoc, _KEYDOWN, onDOMEvent.bind(this, _KEYDOWN));
                        Event.on(oDoc, _KEYUP, onDOMEvent.bind(this, _KEYUP));
                        Event.on(oDoc, _KEYPRESS, onDOMEvent.bind(this, _KEYPRESS));
    
                        Event.onFocus(oDoc, onDOMEvent.bind(this, 'focus'));
                        Event.onBlur(oDoc, onDOMEvent.bind(this, 'blur'));
...
var Dom = YAHOO.util.Dom,
    ...
    // TDS: for events to fire on links we need to add touch action
    _ANCHOR_TEMPLATE = "<a href=\"#\" touch-action=\"none\"></a>",
