    ...
    return {
        ...
        */
        _createShim: function() {
            ...
            this._shim = s;
            Event.on(s, 'pointerup',   this.handleMouseUp, this, true);
            Event.on(s, 'pointermove', this.handleMouseMove, this, true);
        ...
        */
        ...
        _onLoad: function() {
            ...
            Event.on(document, "pointerup",   this.handleMouseUp, this, true);
            Event.on(document, "pointermove", this.handleMouseMove, this, true);
...
YAHOO.util.DragDrop.prototype = {
    ...
    */
    ...
    init: function(id, sGroup, config) {
        ...
        Event.on(this._domRef || this.id, "pointerdown", 
     ...
     */
    unreg: function() {
        Event.removeListener(this.id, "pointerdown", 
